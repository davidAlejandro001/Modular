                ...
                <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tipo Granel</h6>
                        </div>
                        <div class="card-body">
                    ...
                    $pagina = 1;
                            ...
                            $sql_total="SELECT * FROM t_tipogranel";
                    ...
                    $registros=$base->query("SELECT * FROM t_tipogranel ORDER BY descripcion ASC LIMIT $empezar_desde, $tamanio_pags")->fetchAll(PDO::FETCH_OBJ);
                    ...
                    ?>
                        ...
                        <table class='table table-bordered table table-hover' id='dataTable' width='100%' cellspacing='0'>
                            ...
                            <?php
                            foreach ($registros as $granel):?>

                            <tr class='table-light text-dark'>
                                <td><input type='hidden' value= "<?php echo $granel->T_TipoGranel_id ?>"></td>
                                <td class='text-capitalize'><?php echo $granel->descripcion?></td>

                                <td><a href="modify.php?Id=<?php echo $granel->T_TipoGranel_id?> & 
                                                Nom=<?php echo $granel->descripcion?>"><img src="../../../css/modificar.png" width=40 height=40></a>
                                                
                                    <a class="deleteBtn" role="button" onclick="alertaEliminar(<?php echo $granel->T_TipoGranel_id ?>)"><img src="../../../css/borrar.png" width=40 height=40></a></td>
                            </tr>
                            <?php endforeach;   ?>
                        </table>
