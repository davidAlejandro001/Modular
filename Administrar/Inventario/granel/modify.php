                    ...
                    <?php 
                        ...
                        if (!isset($_POST["bot_actualizar"])) {
                                ...
                                <div class="row">
                                    ...
                                    <div class>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="name" placeholder="Nombre Categoria" value="<?php echo $Name?>">
                                        </div>

                                        <div class="my-5">
                                        <button type="submit" class="btn btn-primary" name="bot_actualizar">Actualizar</button>
                                        </div>
                            ...
                            if(empty($name) || empty($id)){
                                ...
                                $tipoError = "No dejes ningun espacio en blanco. ";
                            }
                            ...
                            if($contador > 0){
                               ...
                               // $ErrorFinal = $tipoError . $tipoError2
                                ...
                                <script>
                                    ...
                                    html: '<?php echo "<div>$tipoError<br>$tipoError2<br></div>" ?>',
                                    })
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class>
                                        ...
                                        <input type="hidden" class="form-control" name="id" id="id" value="<?php if(isset($id)) echo $id ?>">
                                    </div>

                                        <!-- ----------------------------------------  Nombre ----------------------------------------------------- -->
                                        <div class="mb-3">
                                            <label  class="form-label">Nombre</label>
                                            <input type="text" class="form-control" name="name" placeholder="Nombre Categoria" value="<?php if(isset($name)) echo $name ?>">
                                        </div>
                        ...
                        <?php
                            ...
                            $sql="UPDATE t_tipogranel SET descripcion=:nom WHERE T_TipoGranel_id=:miId";
                            $resultado=$base->prepare($sql);

                            $resultado->execute(array(":miId"=>$id, ":nom"=>$name));
