                ...
                <div class="container-fluid">
                    ...
                    <?php 
                        ...
                        if (!isset($_POST["bot_actualizar"])) {
                            ...
                            $ape=$_POST["ape"];
                            $phone=$_POST["phone"];
                            //el error de que no se encontraba el array key del checkbox se resolvio al declarar un input de tipo hidden conn el nombre visita
                            //en modify_Form1.php y modify_Form1.php
                            $visita = $_POST["visita"];
                            ...
                            $tipoError3="";
                                ...
                                if(empty($visita) || empty($empresa) || empty($name) || empty($ape) || empty($phone) || empty($id)){
