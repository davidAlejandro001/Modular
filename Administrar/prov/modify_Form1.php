  ...
  <div class="col-8">
    ...
    <form name="form1" method="post" action="<?php echo $_SERVER['PHP_SELF'];  ?>">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="empresa" placeholder="Empresa" value="<?php
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="name" placeholder="Nombre Proveedor" value="<?php
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="ape" placeholder="Apellidos" value="<?php 
        ...
        <div class="form-floating mb-3">
            <input type="tel" class="form-control" 
                pattern="\([0-9]{3}\) [0-9]{3}[ -][0-9]{4}" id="phone" name="phone" value="<?php 
