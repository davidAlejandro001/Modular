            ...
            <div id="content">
                ...
                <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
                    ...
                    if (isset($_POST["enviar"])) {
                                        ...
                                        while($proveedor=$stmt->fetch(PDO::FETCH_ASSOC)){
                                            ...
                                            <tr class='table-light text-dark'>
                                                ...
                                                <td><a href="modify.php?Id=<?php echo $proveedor['TProveedor_id']?> & 
                                                    ...
                                                    <a class="deleteBtn" onclick="alertaEliminar(<?php echo $proveedor['TProveedor_id'] ?>)"><img src="../../css/borrar.png" width=40 height=40></a></td>
                                            </tr>
                                            <?php
                                        }
                        ...
                        $registros=$base->query("SELECT * FROM tproveedor")->fetchAll(PDO::FETCH_OBJ);
