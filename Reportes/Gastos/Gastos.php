            ...
            <li class="nav-item">
                ...
                <div id="collapseRep" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../Rep_Ventas/Rep_Ventas.php">Ventas</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <div style="text-align: right;">
                    ...
                    if(isset($_POST["enviar"])){
                        ...
                        include("conexion.php");
                        $sql2="SELECT * FROM tgastos WHERE fecha BETWEEN ? AND ? ORDER BY fecha ASC";
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Reportes de Gastos</h6>
                        </div>
                        <div class="card-body">
