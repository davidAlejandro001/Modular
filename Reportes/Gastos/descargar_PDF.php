...
$pdf->Cell(100,6,'Reporte de Gastos',0,0,'C');
...
if ($num_registro!=0) {
    ...
    while($dataRow=$stmt->fetch(PDO::FETCH_ASSOC)){
        ...
        $pdf->Cell(40,6,($dataRow['Importe']),1,0,'C');
        $pdf->Cell(100,6,($dataRow['Descripcion']),1,0,'C');
        $pdf->Cell(30,6,(date('d-m-Y', strtotime($dataRow['fecha']))),1,1,'C');
