                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                if(isset($_POST["enviar"])){
                                    ...
                                    if(empty($importe) || empty($desc)){

                                        $tipoError1="No puedes dejar espacios en blanco.";
                                        $contador = $contador + 1;
                                    }
        
                                    if (preg_match("/^[[a-zA-Z áéíóúÁÉÍÓÚñÑ]{7,100}$/i", trim($desc)) !== 1) {
                                        $contador = $contador + 1;
                                    ...
                                    if($contador > 0){
                                        ...
                                        $sql2="INSERT INTO tgastos(Importe, Descripcion, fecha) VALUES (:imp, :descripcion, :fecha)";
                                        $resultado2=$base->prepare($sql2);

                                        $resultado2->execute(array(":imp"=>$importe, ":descripcion"=>$desc, ":fecha"=>$fechaGuardar));
