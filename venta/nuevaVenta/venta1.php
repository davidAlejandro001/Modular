...
<div class="Punto-Venta">
    <div class="Buscador">
        ...
        <input type="text" placeholder="Buscar por codigo barras" name="codigo">
    ...
    <div class="ListaProductos">
        ...
        <div class="Productos">
            ...
            <div class="Buscador">
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" class="Search_Bar" method="post">
                <input class="typeahead form-control" type="text" placeholder="Buscar por Nombre" name="nombre_Prod">
            ...
            <div class="container_cards">
                <div class="Cards_Row">
                    ...
                    if(!isset($_POST["buscar_Nombre"])){
                        ...
                        ($conexion, "SELECT tproductos.TProductos_id, nombre_Articulo, precio, granel, codigo_Barras, Imagen, tinventario.stock, tgranel.T_TipoGranel_id
...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <label  class="col-form-label">Cantidad</label><br>
                <input type="number" class="form-control" class="form-group" id="cantidad" name="cantidad" value="1" max="<?php echo $InventarioTotal ?>" min="0">
            </div>
...
<!-- Boton para insertar articulo de granel -->
<div class="modal fade" id="insertModal_Prod" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
aria-hidden="true">
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="my-5">
<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-footer">
            <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancelar</button>
            <button type="submit" name="agregar2" id="agregar" class="btn btn-primary">Aceptar</button>
        </div>
    </div>
</div>
</form>
