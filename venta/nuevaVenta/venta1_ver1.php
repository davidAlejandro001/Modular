...
<div class="Punto-Venta">
    <div class="Buscador">
        ...
        <input class="typeahead form-control" type="text" placeholder="Buscar por codigo barras o nombre..." name="codigo">
            <button class="Search_btn" type="submit" name="enviar">Buscar</button>
        </form>
    </div>
...
<div class="Productos">
    ...
    <div class="container_cards">
        ...
        <?php 
                $conexion=mysqli_connect("localhost","root","Thewalkingdead_01","sistematiendasjii");
                $consulta = mysqli_query($conexion, "SELECT * from tproductos LIMIT 5");
                    ...
                    while ($fila = $consulta -> fetch_assoc()) { ?> 
                        <div class="Card_Producto">
                            ...
                            <div class="detalles_card">
                                ...
                                <p class="precio_producto">$<?php echo $fila['precio_Compra']?></p>
                            </div>
                        </div> 
                 <?php   } 
                 } 
